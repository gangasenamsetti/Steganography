 ...
 *	
 *	Copyright (c) 2005 - Mohammad Mujeeb
 *	
...
public class BackEndHandler extends Thread
{
	...
	private void showEster(RobustInformation steg)
	{
		Object message[]= new Object[3];
		message[0]= new MyJLabel("This is an encrypted zone.", Color.red, Color.gray);
		message[1]= new JLabel("Please enter Key to continue.");
		...
		if(password.length()<8)
			JOptionPane.showMessageDialog(null, "This was not the right Key!", "Invalid password", JOptionPane.OK_OPTION);
		else
		{
