...
public class EmbedMessageGUI extends JFrame implements ActionListener, ItemListener
{
	...
	{
		super("Embedding message  "+ SecureReversible_ImageDataHiding.VERSION+ "   -- ");
		...
		lblPassword= new JLabel("Secret Key (Minimum 8 chars)");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(source== btnGo)
		{
			...
			if(SecureReversible_ImageDataHiding.embedMessage(client.getMasterFile(), client.getOutputFile(), txtMessage.getText(), compression, password))
